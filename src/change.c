...
*/
const char Change_fileid[] = "Previous change.c : " __DATE__ " " __TIME__;
...
/*-----------------------------------------------------------------------*/
/**
 * Parse given command line and change Previous options accordingly
