...
{	uae_s32 dst = m68k_dreg (regs, dstreg);
	m68k_incpci (4);
	if (!m68k_mull(opcode, dst, extra)) goto l_320844;
}}}l_320844: ;
return 12;
}
...
{	uae_s32 dst = get_long_mmu030_state (dsta);
	m68k_incpci (4);
	if (!m68k_mull(opcode, dst, extra)) goto l_320845;
}}}}l_320845: ;
return 24;
}
...
{	uae_s32 dst = get_long_mmu030_state (dsta);
	...
	m68k_areg (regs, dstreg) += 4;
	m68k_incpci (4);
	if (!m68k_mull(opcode, dst, extra)) goto l_320846;
}}}}l_320846: ;
	mmufixup[0].reg = -1;
return 24;
}
...
{	uae_s32 dst = m68k_dreg (regs, dstreg);
	m68k_incpci (4);
	if (!m68k_divl(opcode, dst, extra)) goto l_320855;
}}}l_320855: ;
return 12;
}
...
{	uae_s32 dst = get_long_mmu030_state (dsta);
	m68k_incpci (4);
	if (!m68k_divl(opcode, dst, extra)) goto l_320856;
}}}}l_320856: ;
return 24;
}
...
{	uae_s32 dst = get_long_mmu030_state (dsta);
	...
	m68k_areg (regs, dstreg) += 4;
	m68k_incpci (4);
	if (!m68k_divl(opcode, dst, extra)) goto l_320857;
}}}}l_320857: ;
	mmufixup[0].reg = -1;
return 24;
}
...
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8); goto l_320885; }
{{	uae_s32 src = m68k_areg (regs, srcreg);
	regs.usp = src;
}}}	m68k_incpci (2);
l_320885: ;
...
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8); goto l_320886; }
...
{
{if (!regs.s) { Exception (8); goto l_320887; }
{	cpureset ();
	m68k_incpci (2);
}}l_320887: ;
return 6;
...
{	uae_u16 newsr; uae_u32 newpc;
	for (;;) {
		...
		else { m68k_areg (regs, 7) += offset; Exception (14); goto l_320890; }
		regs.sr = newsr;
	MakeFromSR();
}
	regs.sr = newsr;
...
{
{if (!regs.s) { Exception (8); goto l_320895; }
{{	uae_s16 src = get_iword_mmu030_state (2);
{	int regno = (src >> 12) & 15;
	uae_u32 *regp = regs.regs + regno;
	if (! m68k_movec2(src & 0xFFF, regp)) goto l_320895;
}}}}	m68k_incpci (4);
l_320895: ;
return 12;
}
...
{
{if (!regs.s) { Exception (8); goto l_320896; }
{{	uae_s16 src = get_iword_mmu030_state (2);
{	int regno = (src >> 12) & 15;
	uae_u32 *regp = regs.regs + regno;
	if (! m68k_move2c(src & 0xFFF, regp)) goto l_320896;
}}}}	m68k_incpci (4);
l_320896: ;
return 12;
}
...
{{	uae_s16 dummy = get_iword_mmu030_state (2);
	if (cctrue (0)) { Exception (7); goto l_320946; }
}}	m68k_incpci (4);
l_320946: ;
return 12;
}
...
{{	uae_s32 dummy;
	...
	if (cctrue (0)) { Exception (7); goto l_320947; }
}}	m68k_incpci (6);
l_320947: ;
return 18;
}
...
{
{	if (cctrue (0)) { Exception (7); goto l_320948; }
}	m68k_incpci (2);
l_320948: ;
return 6;
}
...
{
{{	uae_s16 dummy = get_iword_mmu030_state (2);
	if (cctrue (1)) { Exception (7); goto l_320984; }
}}	m68k_incpci (4);
l_320984: ;
return 12;
}
...
{{	uae_s32 dummy;
	dummy = get_ilong_mmu030_state (2);
	if (cctrue (1)) { Exception (7); goto l_320985; }
}}	m68k_incpci (6);
l_320985: ;
return 18;
}
...
{
{	if (cctrue (1)) { Exception (7); goto l_320986; }
}	m68k_incpci (2);
l_320986: ;
return 6;
}
...
{
{{	uae_s16 dummy = get_iword_mmu030_state (2);
	if (cctrue (2)) { Exception (7); goto l_320996; }
}}	m68k_incpci (4);
l_320996: ;
return 12;
}
...
{{	uae_s32 dummy;
	dummy = get_ilong_mmu030_state (2);
	if (cctrue (2)) { Exception (7); goto l_320997; }
}}	m68k_incpci (6);
l_320997: ;
return 18;
}
...
{
{	if (cctrue (2)) { Exception (7); goto l_320998; }
}	m68k_incpci (2);
l_320998: ;
return 6;
}
...
{
{{	uae_s16 dummy = get_iword_mmu030_state (2);
	if (cctrue (3)) { Exception (7); goto l_321008; }
}}	m68k_incpci (4);
l_321008: ;
return 12;
}
...
{{	uae_s32 dummy;
	dummy = get_ilong_mmu030_state (2);
	if (cctrue (3)) { Exception (7); goto l_321009; }
}}	m68k_incpci (6);
l_321009: ;
return 18;
}
...
{
{	if (cctrue (3)) { Exception (7); goto l_321010; }
}	m68k_incpci (2);
l_321010: ;
return 6;
}
...
{
{{	uae_s16 dummy = get_iword_mmu030_state (2);
	if (cctrue (4)) { Exception (7); goto l_321020; }
}}	m68k_incpci (4);
l_321020: ;
return 12;
}
...
{{	uae_s32 dummy;
	dummy = get_ilong_mmu030_state (2);
	if (cctrue (4)) { Exception (7); goto l_321021; }
}}	m68k_incpci (6);
l_321021: ;
return 18;
}
...
{
{	if (cctrue (4)) { Exception (7); goto l_321022; }
}	m68k_incpci (2);
l_321022: ;
return 6;
}
...
{
{{	uae_s16 dummy = get_iword_mmu030_state (2);
	if (cctrue (5)) { Exception (7); goto l_321032; }
}}	m68k_incpci (4);
l_321032: ;
return 12;
}
...
{{	uae_s32 dummy;
	dummy = get_ilong_mmu030_state (2);
	if (cctrue (5)) { Exception (7); goto l_321033; }
}}	m68k_incpci (6);
l_321033: ;
return 18;
}
...
{
{	if (cctrue (5)) { Exception (7); goto l_321034; }
}	m68k_incpci (2);
l_321034: ;
return 6;
}
...
{
{{	uae_s16 dummy = get_iword_mmu030_state (2);
	if (cctrue (6)) { Exception (7); goto l_321044; }
}}	m68k_incpci (4);
l_321044: ;
return 12;
}
...
{{	uae_s32 dummy;
	dummy = get_ilong_mmu030_state (2);
	if (cctrue (6)) { Exception (7); goto l_321045; }
}}	m68k_incpci (6);
l_321045: ;
return 18;
}
...
{
{	if (cctrue (6)) { Exception (7); goto l_321046; }
}	m68k_incpci (2);
l_321046: ;
return 6;
}
...
{
{{	uae_s16 dummy = get_iword_mmu030_state (2);
	if (cctrue (7)) { Exception (7); goto l_321056; }
}}	m68k_incpci (4);
l_321056: ;
return 12;
}
...
{{	uae_s32 dummy;
	dummy = get_ilong_mmu030_state (2);
	if (cctrue (7)) { Exception (7); goto l_321057; }
}}	m68k_incpci (6);
l_321057: ;
return 18;
}
...
{
{	if (cctrue (7)) { Exception (7); goto l_321058; }
}	m68k_incpci (2);
l_321058: ;
return 6;
}
...
{
{{	uae_s16 dummy = get_iword_mmu030_state (2);
	if (cctrue (8)) { Exception (7); goto l_321068; }
}}	m68k_incpci (4);
l_321068: ;
return 12;
}
...
{{	uae_s32 dummy;
	dummy = get_ilong_mmu030_state (2);
	if (cctrue (8)) { Exception (7); goto l_321069; }
}}	m68k_incpci (6);
l_321069: ;
return 18;
}
...
{
{	if (cctrue (8)) { Exception (7); goto l_321070; }
}	m68k_incpci (2);
l_321070: ;
return 6;
}
...
{
{{	uae_s16 dummy = get_iword_mmu030_state (2);
	if (cctrue (9)) { Exception (7); goto l_321080; }
}}	m68k_incpci (4);
l_321080: ;
return 12;
}
...
{{	uae_s32 dummy;
	dummy = get_ilong_mmu030_state (2);
	if (cctrue (9)) { Exception (7); goto l_321081; }
}}	m68k_incpci (6);
l_321081: ;
return 18;
}
...
{
{	if (cctrue (9)) { Exception (7); goto l_321082; }
}	m68k_incpci (2);
l_321082: ;
return 6;
}
...
{
{{	uae_s16 dummy = get_iword_mmu030_state (2);
	if (cctrue (10)) { Exception (7); goto l_321092; }
}}	m68k_incpci (4);
l_321092: ;
return 12;
}
...
{{	uae_s32 dummy;
	dummy = get_ilong_mmu030_state (2);
	if (cctrue (10)) { Exception (7); goto l_321093; }
}}	m68k_incpci (6);
l_321093: ;
return 18;
}
...
{
{	if (cctrue (10)) { Exception (7); goto l_321094; }
}	m68k_incpci (2);
l_321094: ;
return 6;
}
...
{
{{	uae_s16 dummy = get_iword_mmu030_state (2);
	if (cctrue (11)) { Exception (7); goto l_321104; }
}}	m68k_incpci (4);
l_321104: ;
return 12;
}
...
{{	uae_s32 dummy;
	dummy = get_ilong_mmu030_state (2);
	if (cctrue (11)) { Exception (7); goto l_321105; }
}}	m68k_incpci (6);
l_321105: ;
return 18;
}
...
{
{	if (cctrue (11)) { Exception (7); goto l_321106; }
}	m68k_incpci (2);
l_321106: ;
return 6;
}
...
{
{{	uae_s16 dummy = get_iword_mmu030_state (2);
	if (cctrue (12)) { Exception (7); goto l_321116; }
}}	m68k_incpci (4);
l_321116: ;
return 12;
}
...
{{	uae_s32 dummy;
	dummy = get_ilong_mmu030_state (2);
	if (cctrue (12)) { Exception (7); goto l_321117; }
}}	m68k_incpci (6);
l_321117: ;
return 18;
}
...
{
{	if (cctrue (12)) { Exception (7); goto l_321118; }
}	m68k_incpci (2);
l_321118: ;
return 6;
}
...
{
{{	uae_s16 dummy = get_iword_mmu030_state (2);
	if (cctrue (13)) { Exception (7); goto l_321128; }
}}	m68k_incpci (4);
l_321128: ;
return 12;
}
...
{{	uae_s32 dummy;
	dummy = get_ilong_mmu030_state (2);
	if (cctrue (13)) { Exception (7); goto l_321129; }
}}	m68k_incpci (6);
l_321129: ;
return 18;
}
...
{
{	if (cctrue (13)) { Exception (7); goto l_321130; }
}	m68k_incpci (2);
l_321130: ;
return 6;
}
...
{
{{	uae_s16 dummy = get_iword_mmu030_state (2);
	if (cctrue (14)) { Exception (7); goto l_321140; }
}}	m68k_incpci (4);
l_321140: ;
return 12;
}
...
{{	uae_s32 dummy;
	dummy = get_ilong_mmu030_state (2);
	if (cctrue (14)) { Exception (7); goto l_321141; }
}}	m68k_incpci (6);
l_321141: ;
return 18;
}
...
{
{	if (cctrue (14)) { Exception (7); goto l_321142; }
}	m68k_incpci (2);
l_321142: ;
return 6;
}
...
{
{{	uae_s16 dummy = get_iword_mmu030_state (2);
	if (cctrue (15)) { Exception (7); goto l_321152; }
}}	m68k_incpci (4);
l_321152: ;
return 12;
}
...
{{	uae_s32 dummy;
	dummy = get_ilong_mmu030_state (2);
	if (cctrue (15)) { Exception (7); goto l_321153; }
}}	m68k_incpci (6);
l_321153: ;
return 18;
}
...
{
{	if (cctrue (15)) { Exception (7); goto l_321154; }
}	m68k_incpci (2);
l_321154: ;
return 6;
}
...
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8); goto l_321785; }
{	uaecptr pc = m68k_getpc ();
...
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8); goto l_321786; }
{	uaecptr pc = m68k_getpc ();
	uae_u16 extra = get_iword_mmu030_state (2);
	m68k_incpci (4);
	uae_u16 extraa = 0;
...
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8); goto l_321787; }
{	uaecptr pc = m68k_getpc ();
	uae_u16 extra = get_iword_mmu030_state (2);
	m68k_incpci (4);
{	uaecptr extraa;
...
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8); goto l_321820; }
{
#ifdef FPUEMU
	m68k_incpci (2);
	fpuop_save (opcode);
...
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8); goto l_321821; }
{
#ifdef FPUEMU
	m68k_incpci (2);
	fpuop_save (opcode);
...
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8); goto l_321822; }
{
#ifdef FPUEMU
	m68k_incpci (2);
	fpuop_save (opcode);
