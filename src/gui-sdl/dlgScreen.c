/*
  Previous - dlgScreen.c

  This file is distributed under the GNU Public License, version 2 or at
  your option any later version. Read the file gpl.txt for details.

 Atari monitor and Previous window settings.
*/
const char DlgScreen_fileid[] = "Previous dlgScreen.c : " __DATE__ " " __TIME__;
...
static SGOBJ windowdlg[] =
{
    ...
    { SGTEXT,     0, 0,  4,2, 20,1, "Previous screen options" },
