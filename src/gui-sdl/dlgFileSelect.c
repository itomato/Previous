/*
  Previous - dlgFileSelect.c
 
  This file is distributed under the GNU Public License, version 2 or at
  your option any later version. Read the file gpl.txt for details.
 
  A file selection dialog for the graphical user interface for Previous.
*/
const char DlgFileSelect_fileid[] = "Previous dlgFileSelect.c : " __DATE__ " " __TIME__;
