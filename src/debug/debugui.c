...
*/
const char DebugUI_fileid[] = "Previous debugui.c : " __DATE__ " " __TIME__;
...
/**
 * Command: Change Previous work directory
 */
...
static const dbgcommand_t uicommand[] =
{
	...
	{ DebugUI_ChangeDir, NULL,
	  ...
	  "change directory",
	  "<directory>\n"
	  "\tChange Previous work directory.",
	  false },
	...
	{ DebugUI_SetOptions, Opt_MatchOption,
	  "setopt", "o",
	  "set Previous command line and debugger options",
	  "[<bin|dec|hex>|<command line options>]\n"
	  "\tSet Previous options. For example to enable exception catching,\n"
	...
	{ DebugUI_SetTracing, Log_MatchTrace,
	  "trace", "t",
	  "select Previous tracing settings",
	  "[set1,set2...]\n"
      "\tSelect Previous tracing settings. 'help' shows all the available\n"
...
/**
 * Set debugger commands file during Previous startup before things
