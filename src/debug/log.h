...
/* these present user with a dialog and log the issue */
	LOG_FATAL,	/* Previous can't continue unless user resolves issue */
...
/* these just log the issue */
	...
	LOG_DEBUG,	/* information about internal Previous working */
 ...
 * just for the Previous developers, tracing support is compiled in
 * by default.
 * 
...
/* Up to 64 levels when using Uint32 for PreviousTraceFlags */
