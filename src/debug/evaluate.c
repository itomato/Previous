...
*/
const char Eval_fileid[] = "Previous calculate.c : " __DATE__ " " __TIME__;
...
static int getValue(const char *str, Uint32 *number, int *base, bool bForDsp)
{
    ...
    *base = 0; /* no base (e.g. variable) */
    ...
    /* internal Previous variable? */
//    if (BreakCond_GetPreviousVariable(name, number)) {
//        return len;
//    }
