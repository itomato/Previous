...
{
	return (NSAlertDefaultReturn == NSRunInformationalAlertPanel(@"Previous", [NSString stringWithCString:szMessage encoding:NSASCIIStringEncoding], nil, nil, nil));
}
...
{
	return (NSAlertDefaultReturn == NSRunAlertPanel(@"Previous", [NSString stringWithCString:szMessage encoding:NSASCIIStringEncoding],
