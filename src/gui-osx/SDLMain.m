...
//		NSString* path = [self displayFileSelection:ConfigureParams.Video.AviRecordFile preferredFileName:@"previous.avi" 
...
{
	GuiOsx_Pause();
//	NSString* path = [self displayFileSelection:ConfigureParams.Sound.szYMCaptureFileName preferredFileName:@"previous.wav"
...
- (IBAction)saveMemorySnap:(id)sender
{
	...
	NSString* path = [self displayFileSelection:ConfigureParams.Memory.szMemoryCaptureFileName preferredFileName:@"previous.sav"
...
{
	[[NSWorkspace sharedWorkspace] openURL:[NSURL URLWithString:@"http://previous.berlios.de/docs.html"]];
}
