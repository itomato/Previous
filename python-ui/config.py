#!/usr/bin/env python
#
# Class and helper functions for handling (Previous) INI style
...
# ------------------------------------------------------
# Helper functions for type safe Previous configuration variable access.
...
# ------------------------------------------------------
# Handle INI style configuration files as used by Previous
...
class ConfigStore:
    ...
    def _get_full_userpath(self, leafdir):
        ...
        # user's previous.cfg can be in home or current work dir,
